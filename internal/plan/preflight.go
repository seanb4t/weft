...
// graph plan (grounded against bd graph schema_version 1, which the CI-pinned
// bd emits — enforced by the internal/plan drift sentinel). Classify on this
// marker, not loose English — mirrors the gh-api error-classification convention.
